...
- [ ] **Task 1.1:** Initialize React + TypeScript project with Vite (30 min)
  - Create project: `npm create vite@latest math-tutor -- --template react-ts`
  - Install dependencies: `npm install`
  - Verify dev server runs: `npm run dev`
  - Test hot reload functionality

- [ ] **Task 1.2:** Install core dependencies (15 min)
  ```bash
...
- [ ] **Task 1.5:** Set up OpenAI API (15 min)
...
#### Design System Setup
- [ ] **Task 1.6:** Create design constants (30 min)
...
- [ ] **Task 1.7:** Create CSS files (45 min)
...
#### Basic Chat UI
- [ ] **Task 1.8:** Create Message type definition (15 min)
  - `src/types/message.ts`
  - Define Message interface (id, role, content, timestamp)
  - Export types

- [ ] **Task 1.9:** Build Message component (30 min)
...
- [ ] **Task 1.10:** Build MessageList component (30 min)
...
- [ ] **Task 1.11:** Build InputArea component (30 min)
...
- [ ] **Task 1.12:** Build ChatContainer component (30 min)
...
- [ ] Basic chat UI renders with mock data
